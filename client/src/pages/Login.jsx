...
export default function Login() {
	...
	return (
		<>
			<div className="flex justify-center items-center h-screen w-screen font-body bg-primary-100 bg-[url('avinyaLogo.jpg')] bg-cover bg-center ">
				<div className="border-2 rounded-md shadow-sm px-12 pt-12 bg-white flex flex-col">
					...
					<form onSubmit={handleSubmit} className="flex flex-col ">
						...
						<span className="mb-4">
						<span><input type="radio" name="role" id="role1" className="mr-1 cursor-pointer"/><label className="mr-8 cursor-pointer" htmlFor="role1">Employee</label></span>
						<span><input type="radio" name="role" id="role2" className="mr-1 cursor-pointer" /><label htmlFor="role2" className=" cursor-pointer">Employer</label></span></span>
						<label className="text-md" htmlFor="username">
							Enter secret ID:
						</label>
						<input
